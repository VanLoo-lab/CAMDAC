...
library(CAMDAC)
CAMDAC::download_pipeline_files(bbseq="rrbs", directory="pipeline_files/")
```
...
You can look up all of the wrapper arguments using the command ```{r}help(CAMDAC::pipeline_tumor_normal)```.
