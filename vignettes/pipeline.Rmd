...
A tab-delimited text file can be provided in the following format:
...
tumor <- CamSample(id="T",bam=b_tumor)
...
Next, see `vignettes("output")` for a detailed summary of CAMDAC results files.
