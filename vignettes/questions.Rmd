...
If for any reason, you have changed the output directory structure from previous run, you can initiate CAMDAC by manually passing outputs to `CSample` objects. See the vignette `vignettes("output")` for more information.
